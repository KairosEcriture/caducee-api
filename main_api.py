# =============================================================================
#  CADUCEE - BACKEND API
#  Version : 3.2.1 (Correction de la syntaxe 'IndentationError')
#  Date : 10/09/2025
# =============================================================================
...
# --- 1. CONFIGURATION ---
app = FastAPI(title="Caducée API", version="3.2.1")
...
# --- 4. ENDPOINTS API ---
@app.get("/", tags=["Status"])
def read_root(): return {"status": "Caducée API v3.2.1 (Stable) est en ligne."}
...
def find_nearby_doctors(request: NearbyDoctorsRequest):
    if not gmaps: raise HTTPException(status_code=500, detail="Service de géolocalisation non configuré.")
    try:
