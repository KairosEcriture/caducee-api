# =============================================================================
#  CADUCEE - BACKEND API
#  Version : 3.2.2 (Correction du chargement de la clé Google Maps)
#  Date : 10/09/2025
# =============================================================================
...
# --- 1. CONFIGURATION ---
app = FastAPI(title="Caducée API", version="3.2.2")
...
# --- 4. ENDPOINTS API ---
@app.get("/", tags=["Status"])
def read_root(): return {"status": "Caducée API v3.2.2 (Stable) est en ligne."}
