# =============================================================================
#  CADUCEE - BACKEND API
#  Version : 2.3 (Calibration finale du prompt de dialogue)
#  Date : 05/09/2025
# =============================================================================
import os
import json
...
# --- 1. CONFIGURATION ---
app = FastAPI(title="Caducée API", version="2.3.0")
...
# --- 3. ENDPOINTS API ---
@app.get("/", tags=["Status"])
def read_root(): return {"status": "Caducée API v2.3 (Dialogue Stable) est en ligne."}
